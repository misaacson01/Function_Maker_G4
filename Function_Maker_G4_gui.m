...
set(hObject, 'String', {'static', 'sawtooth', 'triangle', 'sine', 'cosine', 'square'});
...
set(handles.edit3,'enable',vis{2})
set(handles.edit5,'enable',vis{2})
set(handles.checkbox2,'enable',vis{2})
...
set(handles.edit8,'enable',vis{2})
set(handles.edit10,'enable',vis{2})
set(handles.checkbox4,'enable',vis{2})
...
set(handles.edit13,'enable',vis{2})
set(handles.edit15,'enable',vis{2})
set(handles.checkbox6,'enable',vis{2})
...
set(handles.edit18,'enable',vis{2})
set(handles.edit20,'enable',vis{2})
set(handles.checkbox8,'enable',vis{2})
...
set(handles.edit23,'enable',vis{2})
set(handles.edit25,'enable',vis{2})
set(handles.checkbox10,'enable',vis{2})
...
section_strings = {'static','sawtooth', 'triangle', 'sine', 'cosine', 'square'};
